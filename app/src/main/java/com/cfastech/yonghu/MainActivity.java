...
public class MainActivity extends AppCompatActivity {
    ...
    private void showPrivacyDialog() {
        String privacyStr = "<p style=\"font-size:16px; text-indent:2em;\">感谢您使用惠众宝App。为了更好地保护您的权益，" +
                "请在使用前充分阅读并理解<a href=\"https://qbhb.emgot.com/service_hzb.html\" style=\"color: #0081ff; display:inline;\">《用户服务协议》</a>" +
                "和<a href=\"https://qbhb.emgot.com/privacy_hzb.html\" style=\"color: #0081ff; display:inline;\">《隐私政策》</a>，" +
    ...
    private void startUniApp() {
        ...
        DCUniMPSDK.getInstance().initialize(this, config, new DCUniMPSDK.IDCUNIMPPreInitCallback() {
            ...
            public void onInitFinished(boolean b) {
                try {
                    DCUniMPSDK.getInstance().startApp(MainActivity.this, "__UNI__5ECF05A");
                    // 监听Uni小程序退出事件
    ...
    private boolean checkPrivacy() {
        SharedPreferences pref = getSharedPreferences("EMGOT_HZB", MODE_PRIVATE);
    ...
    private void savePrivacy(boolean privacyState) {
        SharedPreferences.Editor editor = getSharedPreferences("EMGOT_HZB",MODE_PRIVATE).edit();
